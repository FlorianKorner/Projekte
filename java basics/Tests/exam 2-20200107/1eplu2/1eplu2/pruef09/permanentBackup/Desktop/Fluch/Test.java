...
public class Test {
    ...
    /**
     * Added this to so the class can be used as main/program
     * @param args
     */
    ...
    public static void test() {
        ...
        if(!stop.addBus(c, 0))System.out.println("Mid error 0");
        if(stop.addBus(c, 0))System.out.println("Mid error 1");
